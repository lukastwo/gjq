    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.lukas.three");
                servletContext.setInitParameter("tapestry.development-modules", "com.lukas.three.services.DevelopmentModule");
